...
console.log('3. Second supplyChange is:', secondItem);

// 4. The last item was added by mistake. Remove it from the 'supplyChanges'
//    array & console.log the value removed.
let removedItem = supplyChanges.pop();
console.log('4. Removed item:', removedItem);
console.log('The items are now:', supplyChanges);
...
let filledBoxes = 0;
while (stashParts >= 7) {
  stashParts = stashParts - 7;
  filledBoxes++;
}

console.log(`Total number of boxes filled is: ${filledBoxes}`);
console.log(`Total remaining parts are: ${stashParts}`);
